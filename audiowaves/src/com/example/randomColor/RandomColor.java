...
public class RandomColor {
    ...
    private HashMap<String, ColorInfo> colors = new HashMap<String, ColorInfo>();
    ...
    private void loadColorBounds() {
        List<Range> lowerBounds1 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds2 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds4 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds5 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds6 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds7 = new ArrayList<Range>();
        ...
        List<Range> lowerBounds8 = new ArrayList<Range>();
